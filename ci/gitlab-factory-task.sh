...
(
  ...
  export OPENAI_TOTAL_TIMEOUT_SECONDS="${OPENAI_TOTAL_TIMEOUT_SECONDS:-1800}"
  export OPENAI_EXPLORATION_REQUEST_TIMEOUT_SECONDS="${OPENAI_EXPLORATION_REQUEST_TIMEOUT_SECONDS:-180}"
  export OPENAI_FINAL_REQUEST_TIMEOUT_SECONDS="${OPENAI_FINAL_REQUEST_TIMEOUT_SECONDS:-90}"
  export OPENAI_REPAIR_REQUEST_TIMEOUT_SECONDS="${OPENAI_REPAIR_REQUEST_TIMEOUT_SECONDS:-90}"
